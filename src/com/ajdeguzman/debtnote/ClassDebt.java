...
public class ClassDebt {
	...
	public ClassDebt(int id, String _debt_amount, String _debt_date, String _debt_due, int _debt_type, String _debt_person, String _debt_desc, String _debt_due_parse){
		this._id = id;
	...
	public ClassDebt(String _debt_amount, String _debt_date, String _debt_due, int _debt_type, String _debt_person, String _debt_desc, String _debt_due_parse){
		this._debt_amount = _debt_amount;
		this._debt_date = _debt_date;
		this._debt_due = _debt_due;
		this._debt_type= _debt_type;
